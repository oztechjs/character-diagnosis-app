...
class _CharacterQuestionPageState extends State<CharacterQuestionPage> {
  ...
  final List<String> questions = [
    'Q1: 週に何コマ授業を履修していますか？（0〜25コマ）',
    'Q2: その中で、1限に入っているコマ数は何回ですか？（0〜5回）',
    'Q3: この1週間に、授業を（病欠等やむを得ない理由以外で）何コマ休みましたか？（0〜25コマ）',
    'Q4: この1週間に、授業の代筆を友人に頼んだことは何回くらいありますか？（0〜25回）',
    'Q5: 週に何回バイトをしていますか？（0〜6回）',
    'Q6: 週に何回サークルや部活に参加していますか？（0〜5回）',
    'Q7: 週に空きコマは何コマありますか？（0〜10コマ）',
    'Q8: 集中力には自信がありますか？（1:すぐ気が散る 〜 10:超集中型）',
    'Q9: ストレス耐性はどれくらいありますか？（1:すぐ病む 〜 10:鋼メンタル）',
    'Q10: 学業・活動へのモチベーションは？（1:やる気なし 〜 10:燃えている）',
    'Q11: 自分の生活がどれくらい忙しいと感じますか？（1:余裕 〜 10:超多忙）',
    'Q12: 未知の体験への態度を選んでください。',
    'Q13: 何か新しいことを始めようとするとき、あなたのスタイルは？',
    'Q14: 新しいことや興味のあることに対して、あなたはどちらに近いですか？',
    'Q15: 解決が難しい問題や大きな壁に直面した時、あなたはまずどうしますか？',
    'Q16: あなたが最も活動的になったり、集中できたりする時間帯はいつ頃ですか？',
    'Q17: ゆるい授業中（楽単など）は何をして過ごすことが多いですか？',
  ];
